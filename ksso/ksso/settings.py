"""
Django settings for ksso project.
...
SECRET_KEY = 'k#57lhp&8m&n^^hg$s+@a&k$@j%6+x&myx7!typti(ayli2r#g'
...
ROOT_URLCONF = 'ksso.urls'

WSGI_APPLICATION = 'ksso.wsgi.application'
